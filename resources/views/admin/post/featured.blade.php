...
@section('title') Featured News -  {{ config('app.name', 'Laravel') }} @endsection
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Featured News</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="{{ route('post.add') }}" class="btn add-btn"><i class="fa fa-plus"></i> Add News</a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
...
@section('js')
    ...
    <script>
        $('#post-datatable').DataTable({
            ...
            ajax: "{{ route('featured.post') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'thumbnail_image', name: 'thumbnail_image',
                    render: function (data, type, full, meta){
                        if(data){
                            return "<img src={{ URL::to('/') }}/public/uploads/news/" + data +" width='120'   />";
                        }
