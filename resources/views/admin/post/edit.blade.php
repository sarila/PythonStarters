...
@section('site_title') Edit News @endsection
                                           ...
                                           <div class="col-md-12">
                                               <div class="form-group">
                                                   <div class="form-check">
                                                       <input class="form-check-input" type="checkbox"  @if($post->is_featured == 1)   checked @endif name="is_featured">
                                       ...
                                       <div class="row">
                                           <div class="col-md-12">
                                               ...
                                               @if(!empty($post->thumbnail_image))
                                                   <img class="img-responsive" src="{{ asset('public/uploads/news/'.$post->thumbnail_image) }}" height="230" width="380" alt="" style="margin-bottom: 10px" id="one">
                                               @else
                                           ...
                                           <div class="col-md-12">
                                               ...
                                               @if(!empty($post->video))
                                                   <a href="{{ asset('public/uploads/news/videos/'.$post->video) }}" class="pull-right" target="_blank"> &nbsp;  View Video</a>
                                       ...
                                       <div class="row">
                                           <div class="col-md-12">
                                               <div class="form-group">
                                                   ...
                                                   <input class="form-control" type="text" name="seo_title" id="seo_title" value="{{ $post->seo_title }}">
                                               </div>
                                           </div>
                                           <div class="col-md-12">
                                               <div class="form-group">
                                                   <label for="seo_subtitle" style="font-size: 14px">SEO Sub Title</label>
                                                   <input class="form-control" type="text" name="seo_subtitle" id="seo_subtitle" value="{{ $post->seo_subtitle }}" >
                                               </div>
                                           </div>
                                           ...
                                           <div class="col-md-12">
                                               <div class="form-group">
                                                   ...
                                                   <input class="form-control" type="text" name="keywords" id="keywords" value="{{ $post->keywords }}">
                                               </div>
                                           </div>
                                       </div>
                                   </div>
